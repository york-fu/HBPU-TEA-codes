...
{ 
	...
	if(reg!=OV2640_PID)
	{
 	...
 	//初始化 OV2640,采用svga分辨率(800*600)@30
...
void OV2640_Config()
{
	...
	OV2640_Color_Saturation(3);	//色彩饱和度1
	OV2640_Brightness(2);		//亮度0
	OV2640_Contrast(2);			//对比度0
		 
	OV2640_OutSize_Set(ImageSize_X,ImageSize_Y);	//4:3
}
