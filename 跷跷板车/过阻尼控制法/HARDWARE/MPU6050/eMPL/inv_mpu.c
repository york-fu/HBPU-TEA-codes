...
//返回值:0,正常
//    其他,失败
u8 mpu_dmp_get_data(float *pitch, float *roll, float *yaw, short *xAngularSpeed, short *yAngularSpeed, short *zAngularSpeed)
{
	...
	**/
	if(sensors&INV_WXYZ_QUAT) 
	{
		...
		*xAngularSpeed = gyro[1];
		*yAngularSpeed = gyro[0];
