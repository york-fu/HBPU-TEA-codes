...
{	 
	...
	u8 x=0;
	u8 x1=0,x2=0,x3=0,x4=0,x5=0,x6=0;
	u8 x7=0,x8=0,x9=0,x10=0,x11=0;
	double temp=0;
	static const u8 buf_1[]="P1:";
	static const u8 buf_2[]="I1:";
	static const u8 buf_3[]="D1:";
	static const u8 buf_4[]="P2:";
	static const u8 buf_5[]="I2:";
	static const u8 buf_6[]="D2:";
	static const u8 buf_7[]="EN:";
	static const u8 buf_8[]="SS:";
	static const u8 buf_9[]="TT:";
	static const u8 buf_10[]="XX:";
	static const u8 buf_11[]="XX:";
	...
	if((USART1_RX_STA&0x8000)==0x8000)	//数据接收完成
	{
		...
		if(x1==3||x2==3||x3==3||x4==3||x5==3||x6==3||x7==3||x8==3||x9==3||x10==3||x11==3)	//格式正确,处理数据
		{
			...
			{
				/*PID调节*/
//				case 1:Pid.Kp = temp;printf("Pid.Kp = %f\r\n",Pid.Kp);
//					break;
//				case 2:Pid.Ki = temp;printf("Pid.Ki = %f\r\n",Pid.Ki);
//					break;
//				case 3:Pid.Kd = temp;printf("Pid.Kd = %f\r\n",Pid.Kd);
//					break;
				
				case 7:Run = (u8)temp;printf("Run = %d\r\n",Run);
					break;
				case 8:PWMvalue = (u16)temp;printf("PWMvalue = %d\r\n",PWMvalue);
					break;
				case 9:Time = (u8)temp;printf("Time = %d\r\n",Time);
					break;
