...
const unsigned char txAddr[TX_ADR_WIDTH] = { 0x12, 0x23, 0x13, 0x23, 0x01 };		//发送地址
const unsigned char rxAddr[RX_ADR_WIDTH] = { 0x12, 0x23, 0x13, 0x23, 0x01 };		//接收地址
...
*返 回 值:	无
***********************************************************************/
void Nrf24l01DelayUs(unsigned int t)
{
	while(t--);
}
