...
u8 lightmode=0,effect=0;					//OV7670设置参数
u8 saturation=4,brightness=2,contrast=0;	//OV7670设置参数
/*范围： 0, 1, 2, 3, 4*/
/*对应：-2,-1, 0, 1, 2*/
...
void OV7670_Config()
{
	...
	OV7670_Color_Saturation(saturation);//饱和度设置
