...
//返回值:0,正常
//    其他,失败
u8 mpu_dmp_get_data(float *pitch, float *roll, float *yaw, short *X_AngularSpeed, short *Y_AngularSpeed, short *Z_AngularSpeed)
{
	...
	static short x_AngularSpeed,y_AngularSpeed,z_AngularSpeed;
	
	static float Last_Pitch,Last_Roll,Last_Yaw;
	static short Last_x_AngularSpeed,Last_y_AngularSpeed,Last_z_AngularSpeed;
	...
	**/
	...
	{	
		/*****************************************************************************/
		/*记录上次数据*/
		Last_Pitch = Pitch;	//俯仰角
		Last_Roll = Roll;	//横滚角
		Last_Yaw = Yaw;		//航向角
				
		Last_x_AngularSpeed = x_AngularSpeed;
		Last_y_AngularSpeed = y_AngularSpeed;
		Last_z_AngularSpeed = z_AngularSpeed;
		/*****************************************************************************/
		...
		x_AngularSpeed = gyro[1];
		y_AngularSpeed = gyro[0];
		z_AngularSpeed = gyro[2];
			
		/**************************************************************************************/
		/*一阶低通滤波*/
		*pitch = 0.3 * Pitch + 0.7 * Last_Pitch;
		*roll  = 0.3 * Roll  + 0.7 * Last_Roll;
		*yaw   = 0.3 * Yaw   + 0.7 * Last_Yaw;
		
		*X_AngularSpeed = 0.3 * (float)x_AngularSpeed + 0.7 * (float)Last_x_AngularSpeed;
		*Y_AngularSpeed = 0.3 * (float)y_AngularSpeed + 0.7 * (float)Last_y_AngularSpeed;
		*Z_AngularSpeed = 0.3 * (float)z_AngularSpeed + 0.7 * (float)Last_z_AngularSpeed;
		/**************************************************************************************/
	}
	else 
		return 2;
