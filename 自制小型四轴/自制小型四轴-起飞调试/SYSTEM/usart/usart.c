...
void Usart1_Dispose()	//串口数据处理
{
	...
	if((USART_RX_STA&0x8000)==0x8000)	//数据接收完成
	{
		...
		if(x1==3||x2==3||x3==3||x4==3||x5==3||x6==3||x7==3||x8==3||x9==3||x10==3||x11==3)	//格式正确,处理数据
		{
			...
			{
				/*PID调节*/
				case 1:Pid_X.P = temp; printf("Pid_X.P = %f\r\n",Pid_X.P);
					break;
				case 2:Pid_X.I = temp; printf("Pid_X.I = %f\r\n",Pid_X.I);
					break;
				case 3:Pid_X.D = temp; printf("Pid_X.D = %f\r\n",Pid_X.D);
					break;
				
				case 4:Pid_Y.P = temp; printf("Pid_Y.P = %f\r\n",Pid_Y.P);
					break;
				case 5:Pid_Y.I = temp; printf("Pid_Y.I = %f\r\n",Pid_Y.I);
					break;
				case 6:Pid_Y.D = temp; printf("Pid_Y.D = %f\r\n",Pid_Y.D);
					break;
				
				case 7:Pid_Z.P = temp; printf("Pid_Z.P = %f\r\n",Pid_Z.P);
					break;
				case 8:Pid_Z.I = temp; printf("Pid_Z.I = %f\r\n",Pid_Z.I);
					break;
				case 9:Pid_Z.D = temp; printf("Pid_Z.D = %f\r\n",Pid_Z.D);
					break;				
			}
		}
