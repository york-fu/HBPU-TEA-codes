...
{	 
	...
	if((USART1_RX_STA&0x8000)==0x8000)	//数据接收完成
	{
		...
		if(x1==3||x2==3||x3==3||x4==3||x5==3||x6==3||x7==3||x8==3||x9==3||x10==3||x11==3)	//格式正确,处理数据
		{
			...
			{
				/*PID调节*/
				case 1:upPid.Kp = temp;printf("upPid.Kp = %f\r\n",upPid.Kp);
					break;
				case 3:upPid.Kd = temp;printf("upPid.Kd = %f\r\n",upPid.Kd);
					break;
				
				case 4:SpeedPid.Kp = temp;printf("SpeedPid.Kp = %f\r\n",SpeedPid.Kp);
					break;
				case 5:SpeedPid.Ki = temp;printf("SpeedPid.Ki = %f\r\n",SpeedPid.Ki);
					break;
				case 6:SpeedPid.Kd = temp;printf("SpeedPid.Kd = %f\r\n",SpeedPid.Kd);
					break;
